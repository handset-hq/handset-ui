...
export const DOCS_NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Routing builder", href: "/docs/components/routing-builder" },
      ...
      { title: "Usage dashboard", href: "/docs/components/usage-dashboard" },
      { title: "Deliverability panel", href: "/docs/components/deliverability-panel" },
